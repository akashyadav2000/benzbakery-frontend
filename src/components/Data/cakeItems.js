export const CAKE_ITEMS = [
  {
    ...
    cakeD:
      "The Sprinkles Drip Cake is a vibrant and playful dessert adorned with a glossy dripped frosting and a cascade of colorful sprinkles.A delightful combination of sweet flavors and eye-catching aesthetics.",
  ...
  },
  {
    ...
    ingredient:
      "Unsweetended Chocolate Chunks, Baking Soda, Salt,Black berrys, Butter, Granulated Sugar, Vanilla Extract, Buttermilk, Evaporated Milk, Coconut Sweetened, Pecans, Food Color, AP Flour.",
    price: 999,
  },
  {
    id: "005",
    ...
    ingredient:
      "Fresh black berry,All-purpose flour,Cocoa powder,Baking soda & baking powder,salt,Granulated chocolate,vaniila extract Buttermilk,canola oil,Heavy cream, Food coloring,",
    price: 899,
  },
  {
    id: "006",
    ...
    ingredient:
      " Fresh fruits,whole milk,pink gel food colouring,all-purpose flour,baking powder,vanilla extract,salt,granulated sugar,vegetable oil,Rose Buttercream Frosting,rose water powdered sugar,vanilla extract",
  ...
  },
  {
    ...
    ingredient:
      "whole milk, Red or pink gel food colouring,unsalted butter,rose water,all-purpose flour,baking powder,vanilla extract,salt,granulated sugar,vegetable oil,Rose Buttercream Frosting,rose water powdered sugar",
    price: 799,
  },
  {
    id: "008",
    ...
    ingredient:
      "All-purpose flour,Cocoa powder,Baking soda & baking powder,salt,Granulated chocolate,vaniila extract Buttermilk,canola oil,Heavy cream, Food coloring, Light corn syrup",
    price: 899,
  },
];
